            ...
            if(in_array($file_type, $allowTypes)){ 
                ...
                if(is_uploaded_file($file_temp_src)){ 
                    ...
                    try { 
                        ...
                        $query = "INSERT INTO live(sn, logo, teamname) VALUES ('$tm', '$s3_file_link', '$tn')";
                ...
                echo "Your files are not allowed, Go Back <a href='../live/index.php'>Home</a> or <a href='index.php'>Add Again</a>";
            }
        }else{
            echo "Size should not exceed 1 MB; it is too large. Go Back <a href='../live/index.php'>Home</a> or <a href='index.php'>Add Again</a>";
        }
    }else{ 
        $query = "INSERT INTO live(sn, teamname) VALUES ('$tm', '$tn')";
        if(mysqli_query($conn, $query)){
            header("Location: ../live/index.php");
        }else{
            echo "Something is wrong";
